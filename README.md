...
> If you declare a default constructor, you must make sure to initialize all variables manually. Otherwise, Grasmin will
  automatically generate a default constructor initializing all necessary variables.
...
> For better performance, it is recommended to use this approach.
...
* you do not need to explicitly declare a constructor. It will be automatically generated for you.
...
class ExampleJasminClass extends Object {
